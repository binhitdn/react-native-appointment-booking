  ...
  const renderScheduleItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => {
        ...
        console.log(time);
        Alert.alert("Xác nhận đặt lịch hẹn", "Xác nhận đặt lịch lúc" + " " + time + "", [
          {
            text: "Cancel",
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <TouchableOpacity style={styles.button}
            onPress={() => {
              navigation.navigate('DoctorDetailScreen', { name: "Thông tin bác sĩ " + doctor.userData.lastName + ' ' + doctor.userData.firstName, doctor: doctor })
            }}
          >
      ...
      <View style={styles.reviews}>
        ...
        <Text style={styles.reviewsTitle}>Reviews:</Text>
        {
          review.length > 0 ? (
            ...
            >
              <NotData message="Không có đánh giá nào" />
