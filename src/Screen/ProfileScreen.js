  ...
  return (
    <View>
      ...
      <List.Item
            ...
            left={props => 
              <Image source={require("../../assets/profile/chat.png")} style={{width: 30, height: 30,
                marginLeft: 5,
              }} />
          }
            right={props => 
      ...
      <List.Item
            ...
            // description="Item description"
            left={props => 
              <Image source={require("../../assets/profile/planet-earth.png")} style={{width: 30, height: 30,
                marginLeft: 5,
              }} />
          }
            right={props => 
      ...
      <List.Item
            ...
            // description="Item description"
            left={props => 
              <Image source={require("../../assets/profile/dark-mode.png")} style={{width: 30, height: 30,
                marginLeft: 5,
                marginTop: 6
              }} />
            }
